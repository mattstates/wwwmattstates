            ...
            <Grid>
                    ...
                    <div className="pitch">
                        ...
                        <div>
                            <p>
                                ...
                                philosophy is inspired by the definition of service leadership
                                quoted on Wikipedia:
                            </p>
                            <p className="quote">
                                "James Sipe and Don Frick, in their book The Seven Pillars of
                                Servant Leadership, state that servant-leaders are individuals of
                                character, those who put people first, are skilled communicators,
                                are compassionate collaborators, use foresight, are systems
                                thinkers, and exercise moral authority."
                            </p>
                            <p>
                                As a manager I balance performance metrics &amp; productivity goals
                                of the organization with each individual contributor's needs and
                                desires.
                            </p>
                            <p>
                                ...
                                served to motivate and mentor developers as well as keep our
                                projects organized and sprints running smoothly. My development work
                                on Top Gun was primarily front end, but I had a great time getting
                                more familiar with C#, .Net, .Net Core, SQL, and automated testing
                                with Selenium.
                            </p>
                        </div>
                        <p className="quote">
                ...
                <Row>
                    ...
                    <Col className="text-center" xs={12} sm={6} md={4}>
                        ...
                        <hr />
                        <p>Javascript • React.js • HTML • CSS/Sass • Node/Express</p>
                    </Col>

                    <Col className="text-center" xs={12} sm={6} md={4}>
                        <h4>Let me Google something:</h4>
                        <hr />
                        <p>Webpack • C# • .Net Framework/.NetCore</p>
                    </Col>
                    ...
                    <Table responsive>
                        <tbody>
                            ...
                            <tr>
                                <td>LinkedIn</td>
                                <td>
                                    <a href="https://www.linkedin.com/in/mattstates/" target="_new">
